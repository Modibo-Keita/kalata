    ...
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
          ...
          <a class="sidebar-brand brand-logo" href="index.html"><img src="{{ asset('KALATA-Logo-Officiel.png') }}" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="index.html"><img src="{{ asset('KALATA-Logo-Officiel.png') }}" alt="logo" /></a>
        </div>
        <ul class="nav mt-5">
          <li class="nav-item ">
            <hr>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('bulletin') }}">
              ...
              <li class="nav-item nav-profile dropdown border-0">
                ...
                <div class="dropdown-menu navbar-dropdown w-100" aria-labelledby="profileDropdown">
                  <a class="dropdown-item" href="#">
                    <i class="mdi mdi-cached mr-2 text-success"></i> Historique de connexion </a>
                  <a class="dropdown-item" href="#">
